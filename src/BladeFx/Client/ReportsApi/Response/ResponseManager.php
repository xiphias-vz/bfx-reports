...
use BladeFx\Client\ReportsApi\Exception\ReportsResponseException;
...
class ResponseManager implements ResponseManagerInterface
{
    ...
    /**
     * @param \BladeFx\Client\ReportsApi\Response\ResponseFactoryInterface $responseFactory
     */
     ...
     * @param \Psr\Http\Message\ResponseInterface|null $response
     *
     * @throws \BladeFx\Client\ReportsApi\Exception\ReportsResponseException
     *
     * @return void
     */
    ...
    /**
     * @param \BladeFx\Client\ReportsApi\Response\Validator\ResponseValidatorInterface $validator
